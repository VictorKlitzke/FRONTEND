import { Sparkles, Calendar, Users, TrendingUp, Zap, Clock } from "lucide-react";
...
export const RegisterHeroPanel = () => {
  return (
    <div className="hidden lg:flex hero-bg relative overflow-hidden">
      {/* Animated orbs */}
      ...
      <div className="relative z-10 flex flex-col justify-center px-14 py-16 w-full">
        ...
        <div className="mb-10">
          ...
          <h2 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-4">
            Gerencie com muito
            <br />
            <span className="gradient-text-light">mais facilidade</span>
          </h2>
